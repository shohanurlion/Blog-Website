                ...
                <Container>
                    ...
                    <div className='w-[75%] mx-auto'>
                        <div>
                            ...
                            <h1 className='text-[36px] font-bold leading-[40px] font-work-sans text-[#181A2A] py-[20px] '>The Impact of Technology on the Workplace:<br/> How Technology is Changing</h1>
                        ...
                        {/* Artical part */}
                        <div>
                            <p className='font-Source Serif font-normal text-[20px] leading-[32px] pb-[32px]'>Traveling is an enriching experience that opens up new horizons, exposes us to different cultures, and creates memories that last a lifetime. However, traveling can also be stressful and overwhelming, especially if you don't plan and prepare adequately. In this blog article, we'll explore tips and tricks for a memorable journey and how to make the most of your travels.</p>

                            <p className='font-Source Serif font-normal text-[20px] leading-[32px] pb-[32px]'> One of the most rewarding aspects of traveling is immersing yourself in the local culture and customs. This includes trying local cuisine, attending cultural events and festivals, and interacting with locals. Learning a few phrases in the local language can also go a long way in making connections and showing respect.</p>
                            <h3 className='text-[24px] font-bold leading-[28px] font-work-sans text-[#181A2A] pb-[32px]'>Research Your Destination</h3>
                            <p className='font-Source Serif font-normal text-[20px] leading-[32px] pb-[32px]'>Before embarking on your journey, take the time to research your destination. This includes understanding the local culture, customs, and laws, as well as identifying top attractions, restaurants, and accommodations. Doing so will help you navigate your destination with confidence and avoid any cultural faux pas.</p>

                            <p className='font-Source Serif font-normal text-[20px] leading-[32px] pb-[32px]'> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. In hendrerit gravida rutrum quisque non tellus orci ac auctor. Mi ipsum faucibus vitae aliquet nec ullamcorper sit amet. Aenean euismod elementum nisi quis eleifend quam adipiscing vitae. Viverra adipiscing at in tellus.</p>
                            <h3 className='text-[24px] font-bold leading-[28px] font-work-sans text-[#181A2A] pb-[32px]'>Plan Your Itinerary</h3>
                            <p className='font-Source Serif font-normal text-[20px] leading-[32px] pb-[32px]'>While it's essential to leave room for spontaneity and unexpected adventures, having a rough itinerary can help you make the most of your time and budget. Identify the must-see sights and experiences and prioritize them according to your interests and preferences. This will help you avoid overscheduling and ensure that you have time to relax and enjoy your journey.</p>

                            <p className='font-Source Serif font-normal text-[20px] leading-[32px] pb-[32px]'> Vitae sapien pellentesque habitant morbi tristique. Luctus venenatis lectus magna fringilla. Nec ullamcorper sit amet risus nullam eget felis. Tincidunt arcu non sodales neque sodales ut etiam sit amet.</p>

                            {/* Quataion part */}
                            <div className='w-full bg-[#E8E8EA] px-[32px] py-[32px] rounded-[12px] text-center my-4'>
                                <p className='text-[28px] font-medium leading-[32px]'>“ Traveling can expose you to new environments and potential health <br/>risks, so it's crucial to take precautions to stay safe and healthy. ”</p>
                            </div>
                        ...
                        <div>
                            ...
                            <p className='font-Source Serif font-normal text-[20px] leading-[32px] pb-[32px]'>Packing can be a daunting task, but with some careful planning and smart choices, you can pack light and efficiently. Start by making a packing list and sticking to it, focusing on versatile and comfortable clothing that can be mixed and matched. Invest in quality luggage and packing organizers to maximize space and minimize wrinkles.</p>
                        </div>
                        
                        <div>
                            <h3 className='text-[24px] font-bold leading-[28px] font-work-sans text-[#181A2A] pb-[32px]'>Stay Safe and Healthy</h3>
                            <p className='font-Source Serif font-normal text-[20px] leading-[32px] pb-[32px]'>Traveling can expose you to new environments and potential health risks, so it's crucial to take precautions to stay safe and healthy. This includes researching any required vaccinations or medications, staying hydrated, washing your hands frequently, and using sunscreen and insect repellent. It's also essential to keep your valuables safe and secure and to be aware of your surroundings at all times.</p>
                        </div>
